...
* Fix - Fixed slide type issue for animation shortcode
* Fix - Fixed blog shortcode issue
* Fix - Fixed carousel shortcode autoplay issue
...
Added: new option for Contact Form  ( display more fields, required fields)

= 2.2.9 - 31/08/2016 =
Added: new shortcode weather 
Added: new option for Carousel  ( Pagination Style )

= 2.2.8 - 27/07/2016 =
* Fix - Fixed List shortcode issue
...
= 2.2.6 - 23/06/2016 =
* Fix - Fixed portfolio shortcode exclude option issue
...
* Fix - Fixed vimeo/youtube shortcode issue

= 2.2.3 - 03/06/2016 =
* Fixed - Fix colorpicker issue
* Fixed - Fix image frame shortcode issue
* Fixed - Fix table shortcode issue
